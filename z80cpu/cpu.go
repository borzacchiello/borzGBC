...
func handler_ld_1(cpu *Z80Cpu, dst1, dst2 *uint8) {
	*dst1, *dst2 = unpack_regcouple(cpu.getPC16())
}

func handler_ld_2(cpu *Z80Cpu, dst *uint8) {
	*dst = cpu.getPC8()
}

func handler_ld_3(cpu *Z80Cpu, dst_addr uint16, src uint8) {
	cpu.Mem.Write(dst_addr, src)
}

func handler_inc_1(cpu *Z80Cpu, dst *uint8) {
	*dst = *dst + 1
...
func handler_inc_2(cpu *Z80Cpu, dst1, dst2 *uint8) {
	v := pack_regcouple(*dst1, *dst2)
	v += 1
	*dst1, *dst2 = unpack_regcouple(v)
}

func handler_dec_1(cpu *Z80Cpu, dst *uint8) {
	*dst = *dst - 1
...
func handler_add_a(cpu *Z80Cpu, val uint8) {
	old_a := cpu.a
...
var handlers = [256]func(*Z80Cpu){
	...
	func(cpu *Z80Cpu) { handler_ld_1(cpu, &cpu.b, &cpu.c) },                      // 01
	func(cpu *Z80Cpu) { handler_ld_3(cpu, pack_regcouple(cpu.b, cpu.c), cpu.a) }, // 02
	func(cpu *Z80Cpu) { handler_inc_2(cpu, &cpu.b, &cpu.c) },                     // 03
	func(cpu *Z80Cpu) { handler_inc_1(cpu, &cpu.b) },                             // 04
	func(cpu *Z80Cpu) { handler_dec_1(cpu, &cpu.b) },                             // 05
	func(cpu *Z80Cpu) { handler_ld_2(cpu, &cpu.b) },                              // 06
	func(cpu *Z80Cpu) { panic("Opcode 07 unimplemented") },                       // 07
	func(cpu *Z80Cpu) { panic("Opcode 08 unimplemented") },                       // 08
	func(cpu *Z80Cpu) { panic("Opcode 09 unimplemented") },                       // 09
	func(cpu *Z80Cpu) { panic("Opcode 0A unimplemented") },                       // 0A
	func(cpu *Z80Cpu) { panic("Opcode 0B unimplemented") },                       // 0B
	func(cpu *Z80Cpu) { panic("Opcode 0C unimplemented") },                       // 0C
	func(cpu *Z80Cpu) { panic("Opcode 0D unimplemented") },                       // 0D
	func(cpu *Z80Cpu) { panic("Opcode 0E unimplemented") },                       // 0E
	func(cpu *Z80Cpu) { panic("Opcode 0F unimplemented") },                       // 0F
	func(cpu *Z80Cpu) { panic("Opcode 10 unimplemented") },                       // 10
	func(cpu *Z80Cpu) { panic("Opcode 11 unimplemented") },                       // 11
	func(cpu *Z80Cpu) { panic("Opcode 12 unimplemented") },                       // 12
	func(cpu *Z80Cpu) { panic("Opcode 13 unimplemented") },                       // 13
	func(cpu *Z80Cpu) { panic("Opcode 14 unimplemented") },                       // 14
	func(cpu *Z80Cpu) { panic("Opcode 15 unimplemented") },                       // 15
	func(cpu *Z80Cpu) { panic("Opcode 16 unimplemented") },                       // 16
	func(cpu *Z80Cpu) { panic("Opcode 17 unimplemented") },                       // 17
	func(cpu *Z80Cpu) { panic("Opcode 18 unimplemented") },                       // 18
	func(cpu *Z80Cpu) { panic("Opcode 19 unimplemented") },                       // 19
	func(cpu *Z80Cpu) { panic("Opcode 1A unimplemented") },                       // 1A
	func(cpu *Z80Cpu) { panic("Opcode 1B unimplemented") },                       // 1B
	func(cpu *Z80Cpu) { panic("Opcode 1C unimplemented") },                       // 1C
	func(cpu *Z80Cpu) { panic("Opcode 1D unimplemented") },                       // 1D
	func(cpu *Z80Cpu) { panic("Opcode 1E unimplemented") },                       // 1E
	func(cpu *Z80Cpu) { panic("Opcode 1F unimplemented") },                       // 1F
	...
	func(cpu *Z80Cpu) { handler_ld_2(cpu, &cpu.a) },                              // 3E
	...
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.b) },                              // 80
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.c) },                              // 81
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.d) },                              // 82
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.e) },                              // 83
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.h) },                              // 84
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.l) },                              // 85
	...
	func(cpu *Z80Cpu) { handler_add_a(cpu, cpu.getPC8()) },                       // C6
